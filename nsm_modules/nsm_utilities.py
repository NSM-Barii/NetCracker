...
class Utilities:
    ...
    def clear_screen():
        ...
        # LINUX
            ...
            console.print(
                "[bold red]Utilities Module Error:[/bold red] [yellow]failed to clear screen, platform not supported[yellow]"
            )
...
class NetTilities:
    ...
    def get_cipher(cipher):
        ...
        ciphers = {0: "None", 1: "WEP", 2: "TKIP", 3: "AES", 4: "UNKOWN"}
...
class Background_Threads:
    ...
    def get_freq(cls, freq):
        ...
        if freq in range(2412, 2472):
            return "2.4 GHz"
        elif freq in range(5180, 5825):
            return "5 GHz"
        else:
            return "6 GHz"
